        ...
        <div class="compare-colleges-container">
            <div class="compare-colleges">
                ...
                <div class="college-1 college-details">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        $compare_search_sql_1 = "SELECT * FROM `college-details` WHERE MATCH(`college-name`, `college-content`) AGAINST('$compare_search_1')";
                        ...
                        if ($compare_search_row_1 > 0) {
                            while ($compare_search_assoc_1 = mysqli_fetch_assoc($compare_search_result_1)) {
                                ...
                                <div class="college-content-card">
                                    ...
                                    <p><a class="compare_link_1 compare_link" href="/college_walla/college?pid=' . $Compare_know_more_1 . '"> Know More </a></p>
                                </div>';
                            }
                        } else {
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        $compare_table_sql = "SELECT * FROM `comparetable` WHERE MATCH(`compare_table_collage`) AGAINST('$college_name')";
            ...
            <div class="college-2 college-details">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $compare_search_sql_2 = "SELECT * FROM `college-details` WHERE MATCH(`college-name`, `college-content`) AGAINST('$compare_search_2')";
                    ...
                    if ($compare_search_row_2 > 0) {
                        while ($compare_search_assoc_2 = mysqli_fetch_assoc($compare_search_result_2)) {
                            ...
                            <div class="college-content-card">
                                ...
                                <p><a class="compare_link_1 compare_link" href="/college_walla/college?pid=' .    $knowMoreUrl . '"> Know More </a></p>
                            </div>';
                        }
                    } else {
                        echo '<div class="no-content-alert">
